...
procdesc="FireEyeGoldCrystal 是一个GitHub监控和信息收集工具，支持钉钉、Server酱和Telegram推送，过滤敏感词，查找包含关键字的所有仓库并输出到FEGC.xlsx文件     --By Infiltrator"
...
# 关键字列表
SearchList=["CVE-"+str(current_year) , "免杀" , "Bypass Antivirus" , "Exploit" ,
